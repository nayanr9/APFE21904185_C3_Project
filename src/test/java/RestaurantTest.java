...
class RestaurantTest {
    ...
    public void createRestaurant() {
        ...
        restaurant.addToMenu("Ice Cream", 150);
    }
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time() {
        LocalTime openingTime = LocalTime.parse("00:00:01");
        LocalTime closingTime = LocalTime.parse("23:59:59");
        restaurant = new Restaurant("My Cafe", "Chennai", openingTime, closingTime);
    ...
    public void is_restaurant_open_should_return_false_if_time_is_outside_opening_and_closing_time() {
        ...
        LocalTime closingTime = LocalTime.parse("00:00:02");
        restaurant = new Restaurant("My Cafe", "Chennai", openingTime, closingTime);
